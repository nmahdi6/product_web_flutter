...
class StringConst {
  ...
  // use for if else
  static const String NOT_AVAILABLE = "موجود نیست";
  static const String AVAILABLE = "موجود است";
  ...
  static const String ALL_PRODUCT = "همه محصولات";
  static const String POPULAR_PRODUCT = "محصولات پرطرفدار";
  static const String NEW_PRODUCT = "محصولات جدید";
  static const String NEW_IN = "New in";
  static const String SALE = "Sale";
  static const String PROFILE = "Profile";
  static const String SEE_ALL = "مشاهده همه";
  ...
  static const String BUY = "خرید";
  static const String ADD_TO_CART = "اضافه کردن به سبد خرید";
  static const String BACK = "بازگشت";
  static const String UPDATING_MESSAGE =
      "*** به دلیل بروزرسانی سایت کلیه ی سفارش ها از طریق تماس یا با پیامک انجام میشود از لطف و شکیبایی شما ممنونیم ***";
  ...
  // static const String WORKS = "کار ";
  static const String EXPERIENCE = "تجربیات";
  static const String PRIVACY_POLICY = "Privacy Policy";
  static const String PROJECT = "Project";
  static const String WORK = "Where I've Worked";
  static const String SERVICES = "Services";
  static const String CONTACT = "ارتباط با ما";
  static const String PHONE_NUMBER = "شماره موبایل";
  static const String RESUME = "رزومه";
  static const String CERTIFICATIONS = "افتخارات";
  static const String EMAIL_VALUE = "davidcobbina47@gmail.com";

  // Home Page
  static const String HI = "با سلام ";
  static const String DEV_INTRO = "با ما تفاوت را احساس کنید";
  static const String HOME_MAIN_TITLE_TEXT = "به وبسایت ما خوش آمدید! ";
  static const String HOME_MAIN_TEXT =
      """ما در $APP_NAME با سال‌ها تجربه در ارائه محصولات باکیفیت و خدمات متمایز، در کنار شما هستیم. این وبسایت با هدف معرفی شرکت، نمایش دستاوردها و ارائه محصولات متنوع طراحی شده است تا به شما تجربه‌ای بی‌نظیر  در خرید آنلاین ارائه دهیم.
از آخرین محصولات و تخفیف‌های ویژه مطلع شوید و با خیالی آسوده خرید کنید. ماموریت ما جلب رضایت شما و ارائه بهترین‌ها است.

""";
  static const String DEV_TITLE = "مهندس کامپیوتر";
  static const String DEV_DESC =
      "Mobile Engineer / Full Stack Developer / Cloud Devops";
  static const String SEE_MY_WORKS = "See my works";
  static const String SCROLL_DOWN = "به پایین بکشید";
  ...
  static const String VIEW_ALL_PROJECTS = "مشاهده تمامی پروژه ها";

  // Contact Page
  static const String GET_IN_TOUCH = "با من در ارتباط باشید";
  static const String CONTACT_MSG =
      "سلام، پروژه، پیشنهاد شغلی یا کار مشاوره ای برای من دارید؟ در اسرع وقت با من تماس بگیرید.";
  static const String YOUR_NAME = "نام ";
  static const String NAME_ERROR_MSG = " لطفا نام خود را وارد کنید *";
  static const String YOUR_EMAIL = "ایمیل";
  static const String EMAIL_ERROR_MSG = "لطفا یک ایمیل معتبر وارد کنید *";
  static const String SUBJECT = "موضوع";
  static const String SUBJECT_ERROR_MSG =
      " لطفا به من بگویید این پیام در مورد چیست؟ *";
  static const String MESSAGE = "پیام";
  static const String MESSAGE_ERROR_MSG =
      "لطفاً چیزی برای ارسال این فرم وارد کنید *";
  static const String SEND_MESSAGE = "ارسال پیام";
  static const String COPYRIGHT = "©  2025  Built by  $COMPANY_NAME_FA,";
  static const String DESIGNED_BY = "Designed by Mahdi Noori";
  static const String DESIGN_LINK = "https://t.me/Nmahdi600";
  ...
  static const String ABOUT_COMPANY =
      'شرکت ما با افتخار به عنوان یکی از پیشگامان در عرضه محصولات غذایی باکیفیت، فعالیت خود را در زمینه تولید و فروش انواع کلوچه و خرما آغاز کرده است. هدف ما ارائه محصولاتی سالم، تازه و خوش‌طعم است که نه‌تنها نیازهای مشتریان عزیز را برآورده کند، بلکه تجربه‌ای لذت‌بخش از طعم‌های طبیعی و اصیل را به همراه داشته باشد.\n\n'
      'ما با بهره‌گیری از مواد اولیه مرغوب، رعایت استانداردهای بهداشتی و تکیه بر دانش و تجربه تیم حرفه‌ای خود، محصولاتی تولید می‌کنیم که برای تمامی سنین مناسب بوده و به حفظ سلامت و انرژی شما کمک می‌کنند.\n\n'
      'خرمای ما از بهترین مزارع کشور تأمین شده و با دقت فراوری می‌شود تا طعم و خواص طبیعی آن حفظ شود. همچنین کلوچه‌های ما با استفاده از دستورالعمل‌های سنتی و به‌روزترین فناوری‌ها تهیه شده‌اند تا طعمی دلنشین و ماندگار ارائه دهند.\n\n'
  ...
  static const String WORK_TOGETHER_P1 =
      "مایل به همکاری در فروش یا توزیع محصولات هستید؟ ";
  static const String WORK_TOGETHER_P2 = "با ما تماس بگیرید.";

  static const String AVAILABLE_FOR_FREELANCE =
      "I'm available for Consultancy & Freelancing.";
  static const String SAY_HELLO = "بگو سلام";
  ...
  //TODO my email
  static const String DEV_EMAIL = "nmahdi600@gmail.com";
  ...
  // static const String COMPANY_NAME = 'lpaaldldp jbjbhvbghvg cfcf';

  static const String COMPANY_NAME_FA = "شرکت بازرگانی اروم آذران شمس";
  static const String COMPANY_NAME_EN = "sherkat bazargani urum azaran shams";
  ...
  static const String LINKED_IN_URL = "https://www.linkedin.com/in/";
  static const String TWITTER_URL = "https://twitter.com/";
  static const String INSTAGRAM_URL =
      "https://www.instagram.com/orumazaranshams";
  static const String TELEGRAM_URL = "https://t.me/Patrik4023";
